...
%    matrices along the same dimensions. N = NUMEL(A) / (P*Q) is the number
%    of elements in A divided by the number of elements in each matrix.
%
...
%       C = MSTRANSPOSE(A, 2) is a 5x(3x9)x2 array of 3x9 matrices.
%
