...
if p == 1, Ad2 = remove1(a, d1); end % 1 x Q
if q == 1, Ad1 = remove1(a, d2); end % P x 1
if r == 1, Bd2 = remove1(b, d1); end % 1 x S
if s == 1, Bd1 = remove1(b, d2); end % R x 1
...
if s == 1
    if scalarsinB % Syntax 2b (multiprod returns 2-D)
        ...
        c2a = insert1(MULTIPROD(a, Bd1, [d1 d2], d1), d2);
    end
end
...
if p == 1 
    if scalarsinA % Syntax 3b (multiprod returns 2-D)
        ...
        c3a = insert1(MULTIPROD(Ad2, b, d1, [d1 d2]), d1);
    end
end
...
if all([p     s] == 1)
    ...
    if q == r
        ...
        c4b = insert1(MULTIPROD(Ad2, Bd1, [0 d1], [d1 0]), d1);
    end
    ...
    c4cdl = insert1(MULTIPROD(Ad2, Bd1, d1, d1), dimaddC);
    c4cds = insert1(MULTIPROD(Ad2, Bd1, d1    ), dimaddC);
end
